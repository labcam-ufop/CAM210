...
SOURCEFILES_QUOTED_IF_SPACED=adc.c itoa.c pwm.c mainUART.c serial.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/adc.p1 ${OBJECTDIR}/itoa.p1 ${OBJECTDIR}/pwm.p1 ${OBJECTDIR}/mainUART.p1 ${OBJECTDIR}/serial.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/itoa.p1.d ${OBJECTDIR}/pwm.p1.d ${OBJECTDIR}/mainUART.p1.d ${OBJECTDIR}/serial.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/adc.p1 ${OBJECTDIR}/itoa.p1 ${OBJECTDIR}/pwm.p1 ${OBJECTDIR}/mainUART.p1 ${OBJECTDIR}/serial.p1

# Source Files
SOURCEFILES=adc.c itoa.c pwm.c mainUART.c serial.c
...
${OBJECTDIR}/mainUART.p1: mainUART.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/mainUART.p1.d 
	@${RM} ${OBJECTDIR}/mainUART.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"D:/MPLABX/XC8/pic/include" -I"D:/MPLABX/XC8/pic/include/proc" -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/mainUART.p1 mainUART.c 
	@-${MV} ${OBJECTDIR}/mainUART.d ${OBJECTDIR}/mainUART.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/mainUART.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
