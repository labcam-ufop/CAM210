...
LATBbits.LB0 = 0;
if(!PORTDbits.RD3) {_delay((unsigned long)((20)*(8000000/4000.0))); if (!PORTDbits.RD3) {key = '1'; Lcd_Out2(1, 0, "1");}}
else if(!PORTDbits.RD2) {_delay((unsigned long)((20)*(8000000/4000.0))); if (!PORTDbits.RD2){key = '4'; Lcd_Out2(1, 0, "4");}}
else if(!PORTDbits.RD1) {_delay((unsigned long)((20)*(8000000/4000.0))); if (!PORTDbits.RD1){key = '7'; Lcd_Out2(1, 0, "7");}}
else if(!PORTDbits.RD0) {_delay((unsigned long)((20)*(8000000/4000.0))); if (!PORTDbits.RD0){key = 'x'; Lcd_Out2(1, 0, "x");}}

LATBbits.LB0 = 1;
LATBbits.LB1 = 0;

if(!PORTDbits.RD3) {_delay((unsigned long)((20)*(8000000/4000.0))); if (!PORTDbits.RD3){key = '2'; Lcd_Out2(1, 0, "2");}}
else if(!PORTDbits.RD2) {_delay((unsigned long)((20)*(8000000/4000.0))); if (!PORTDbits.RD2){key = '5'; Lcd_Out2(1, 0, "5");}}
else if(!PORTDbits.RD1) {_delay((unsigned long)((20)*(8000000/4000.0))); if (!PORTDbits.RD1){key = '8'; Lcd_Out2(1, 0, "8");}}
else if(!PORTDbits.RD0) {_delay((unsigned long)((20)*(8000000/4000.0))); if (!PORTDbits.RD0){key = '0'; Lcd_Out2(1, 0, "0");}}

LATBbits.LB1 = 1;
LATBbits.LB2 = 0;

if(!PORTDbits.RD3) {_delay((unsigned long)((20)*(8000000/4000.0))); if (!PORTDbits.RD3){key = '3'; Lcd_Out2(1, 0, "3");}}
else if(!PORTDbits.RD2) {_delay((unsigned long)((20)*(8000000/4000.0))); if (!PORTDbits.RD2){key = '6'; Lcd_Out2(1, 0, "6");}}
else if(!PORTDbits.RD1) {_delay((unsigned long)((20)*(8000000/4000.0))); if (!PORTDbits.RD1){key = '9'; Lcd_Out2(1, 0, "9");}}
else if(!PORTDbits.RD0) {_delay((unsigned long)((20)*(8000000/4000.0))); if (!PORTDbits.RD0){key = '-'; Lcd_Out2(1, 0, "-");}}
