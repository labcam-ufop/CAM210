...
# 1 "C:\CAM210\EEPROM_I2C.X\mainEEPROM.c"


# 7 "C:\CAM210\EEPROM_I2C.X\configbits.h"
...
# 18 "c:\PROGRA~1\MICROC~1\xc8\v2.50\pic\include\xc.h"
extern const char __xc8_OPTIM_SPEED;

extern double __fpnormalize(double);


# 13 "c:\PROGRA~1\MICROC~1\xc8\v2.50\pic\include\c90\xc8debug.h"
#pragma intrinsic(__builtin_software_breakpoint)
extern void __builtin_software_breakpoint(void);

# 13 "c:\PROGRA~1\MICROC~1\xc8\v2.50\pic\include\c90\stdint.h"
...
# 7 "c:\PROGRA~1\MICROC~1\xc8\v2.50\pic\include\builtins.h"
...
# 19 "C:/Users/alank/.mchp_packs/Microchip/PIC18Fxxxx_DFP/1.6.159/xc8\pic\include\pic18.h"
...
# 48 "C:\CAM210\EEPROM_I2C.X\flexlcd.h"
void Lcd_Init(void);
...
# 4 "c:\PROGRA~1\MICROC~1\xc8\v2.50\pic\include\c90\__size_t.h"
typedef unsigned size_t;

# 7 "c:\PROGRA~1\MICROC~1\xc8\v2.50\pic\include\c90\stdarg.h"
...
# 43 "c:\PROGRA~1\MICROC~1\xc8\v2.50\pic\include\c90\stdio.h"
struct __prbuf
{
char * ptr;
void (* func)(char);
...
# 29 "c:\PROGRA~1\MICROC~1\xc8\v2.50\pic\include\c90\errno.h"
extern int errno;

# 12 "c:\PROGRA~1\MICROC~1\xc8\v2.50\pic\include\c90\conio.h"
...
# 88 "c:\PROGRA~1\MICROC~1\xc8\v2.50\pic\include\c90\stdio.h"
...
# 32 "C:\CAM210\EEPROM_I2C.X\i2c.h"
void i2c_init(void);
void i2c_start(void);
void i2c_stop(void);
...
# 26 "C:\CAM210\EEPROM_I2C.X\rtc.h"
extern volatile unsigned char date[10];
extern volatile unsigned char time[10];


void rtc_w(unsigned char day, unsigned char mth, unsigned char year, unsigned char dow, unsigned char hr, unsigned char min, unsigned char sec);

void rtc_r(void);

# 27 "C:\CAM210\EEPROM_I2C.X\eeprom.h"
unsigned char e2prom_r(unsigned char addr);

void e2prom_w(unsigned char addr,unsigned char val);

# 28 "C:\CAM210\EEPROM_I2C.X\eeprom_ext.h"
unsigned char e2pext_r(unsigned int addr);
void e2pext_w(unsigned int addr, unsigned char val);

# 19 "C:\CAM210\EEPROM_I2C.X\mainEEPROM.c"
unsigned int duty = 100, count = 0;
unsigned char str[5];
...
rtc_r();
_delaywdt((unsigned long)((50)*(8000000/4000.0)));
