...
LATBbits.LB0 = 0;
if(!PORTDbits.RD3) {_delaywdt((unsigned long)((10)*(8000000/4000.0))); if (!PORTDbits.RD3) {key = '1'; }}
else if(!PORTDbits.RD2) {_delaywdt((unsigned long)((10)*(8000000/4000.0))); if (!PORTDbits.RD2){key = '4'; }}
else if(!PORTDbits.RD1) {_delaywdt((unsigned long)((10)*(8000000/4000.0))); if (!PORTDbits.RD1){key = '7'; }}
else if(!PORTDbits.RD0) {_delaywdt((unsigned long)((10)*(8000000/4000.0))); if (!PORTDbits.RD0){key = 'x'; }}

LATBbits.LB0 = 1;
LATBbits.LB1 = 0;

if(!PORTDbits.RD3) {_delaywdt((unsigned long)((10)*(8000000/4000.0))); if (!PORTDbits.RD3){key = '2'; }}
else if(!PORTDbits.RD2) {_delaywdt((unsigned long)((10)*(8000000/4000.0))); if (!PORTDbits.RD2){key = '5'; }}
else if(!PORTDbits.RD1) {_delaywdt((unsigned long)((10)*(8000000/4000.0))); if (!PORTDbits.RD1){key = '8'; }}
else if(!PORTDbits.RD0) {_delay((unsigned long)((10)*(8000000/4000.0))); if (!PORTDbits.RD0){key = '0'; }}

LATBbits.LB1 = 1;
LATBbits.LB2 = 0;

if(!PORTDbits.RD3) {_delaywdt((unsigned long)((10)*(8000000/4000.0))); if (!PORTDbits.RD3){key = '3'; }}
else if(!PORTDbits.RD2) {_delaywdt((unsigned long)((10)*(8000000/4000.0))); if (!PORTDbits.RD2){key = '6'; }}
else if(!PORTDbits.RD1) {_delaywdt((unsigned long)((10)*(8000000/4000.0))); if (!PORTDbits.RD1){key = '9'; }}
else if(!PORTDbits.RD0) {_delaywdt((unsigned long)((10)*(8000000/4000.0))); if (!PORTDbits.RD0){key = '-'; }}
